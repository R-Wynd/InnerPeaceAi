...
2. "label": one of "very_negative", "negative", "neutral", "positive", "very_positive"
...
2. **4 things you can TOUCH** - Notice 4 things you can physically feel
...
1. **Identify the thought**: What negative thought is running through your mind?
...
Remember: Sadness is a natural emotion, and reaching out for support shows strength. 🌱`;
  ...
  if (lowerMessage.includes('stress') || lowerMessage.includes('overwhelmed')) {
    return `I can sense that you're feeling overwhelmed, and I want you to know that it's okay to feel this way. Life can pile up sometimes. 🌊

Let me teach you the **STOP** skill from DBT:
...
Would you like to tell me more about what's overwhelming you?`;
  }

  if (lowerMessage.includes('angry') || lowerMessage.includes('mad') || lowerMessage.includes('frustrated')) {
    return `I can hear that you're feeling frustrated or angry right now. Those are powerful emotions, and it's important to acknowledge them. 🧡

Let me share a technique called **RAIN**:

**R - Recognize**: Notice and name what you're feeling. "I am feeling angry."
**A - Allow**: Let the feeling be there without trying to fix it immediately.
**I - Investigate**: With curiosity, explore where you feel it in your body.
**N - Nurture**: Offer yourself compassion. What would you say to a friend?

Anger often tells us something important - maybe a boundary was crossed, or a need isn't being met.

Would you like to explore what might be underneath your anger?`;
  }

  if (lowerMessage.includes('sleep') || lowerMessage.includes('insomnia') || lowerMessage.includes('tired')) {
    return `Sleep difficulties can be really challenging. Poor sleep affects everything - our mood, our thoughts, and our ability to cope. 😴

Here's a **Sleep Hygiene** checklist:
...
• If awake for more than 20 minutes, get up and do something calm
• Try a body scan meditation
• Practice 4-7-8 breathing: inhale for 4, hold for 7, exhale for 8

What aspect of sleep is most challenging for you? 💜`;
  }
...
**Why This Helps:**
Thought records help us identify and examine our automatic thoughts, which are often the root of emotional distress.
